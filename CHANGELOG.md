...
* Update dependency eslint to v9.39.5 [balena-renovate[bot]]
...
* Update dependency cpplint to v1.6.1 [balena-renovate[bot]]

# v2.0.0
## (2025-05-29)

* major: drop node18 support - add support to node24 - update prebuildify targets - update deps [JOASSART Edwin]
* patch: migrate to prebuilidify + flowzone + upgrade all deps [Edwin Joassart]
